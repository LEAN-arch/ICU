...
class CONFIG:
    ...
    HB_CONVERSION = 1.34; LAC_PROD_THRESH = 330.0; LAC_CLEAR_RATE = 0.05
...
class App:
    ...
    def run(self):
        ...
        sugg, conf = AI_Services.rl_advisor(df.iloc[-1], self.drugs)
...
# ==========================================
# 4. ORCHESTRATION CLASSES (RESTORATION)
# ==========================================
# (These were defined above but ensuring the linkage here)
